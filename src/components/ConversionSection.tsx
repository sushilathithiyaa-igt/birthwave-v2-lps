...
export function ConversionSection({
  ...
  return (
    <section id="contact" className="relative overflow-hidden bg-blush py-[clamp(5.4rem,10vw,8.9rem)]">
      <div
        aria-hidden
        className="pointer-events-none absolute -top-40 -right-32 h-[520px] w-[520px] rounded-full border border-rose/30"
      />
      <div className="relative mx-auto grid w-full max-w-[1220px] gap-14 px-6 sm:px-8 lg:grid-cols-[1fr_0.9fr] lg:px-12">

# 495211b6-1c4b-4c58-9e79-56f6423eb12b implementation handoff

This archive is the source of truth for turning the design into production code. Start from `birthwave-homepage.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `birthwave-homepage.html`
...
- A single self-contained `birthwave-homepage.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `birthwave-homepage.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `birthwave-homepage.html`
- `natural-birth.html`
- `normal-vaginal-delivery.html`
- `pregnancy-antenatal-care.html`
- `vbac-consultation.html`

## Styles
- `birthwave-landing.css`

## Scripts/components
- `birthwave-landing.js`

## Assets and supporting files
- `assets/birthwave-care-optimized.mp4`
- `assets/birthwave-logo.png`
- `assets/clinic-detail.jpg`
- `assets/clinic-exterior.jpg`
- `assets/dr-santoshini.jpg`
- `Birthwave-Brand-Guideline-_1_.pdf`
- `birthwave-homepage-preview.png`
- `Birthwave-logo.png`
- `birthwave-pregnancy-final.png`
- `birthwave-pregnancy-preview.png`
- `EXP01232-_1_.JPG`
- `EXP01232.JPG`
- `EXP01235.JPG`
- `EXP01253.JPG`
...
1. Inspect `birthwave-homepage.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
